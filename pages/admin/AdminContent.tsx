...
import { Search, Plus, MoreVertical, BookOpen, Clock, Tag, Eye, FileText, Archive, CheckCircle, AlertCircle, RefreshCw, Loader2, Trash2, Network, Share2 } from 'lucide-react';
              ...
              >
                  <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm ${
                          item.category === 'Core' ? 'bg-blue-500' : item.category === 'Tool' ? 'bg-orange-500' : 'bg-green-500'
                      }`}>
                          <Network size={18}/>
                      </div>
                      <div>
