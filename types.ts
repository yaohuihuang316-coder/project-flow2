...
export enum Page {
  ...
  LEARNING_PATH = 'LEARNING_PATH', // 知识图谱学习路径页面
  ...
  // Teacher Data Management (Admin)
  ADMIN_TEACHER_COURSES = 'ADMIN_TEACHER_COURSES',
  ADMIN_TEACHER_ASSIGNMENTS = 'ADMIN_TEACHER_ASSIGNMENTS',
  ADMIN_TEACHER_SESSIONS = 'ADMIN_TEACHER_SESSIONS',
  ADMIN_TEACHER_TEACHERS = 'ADMIN_TEACHER_TEACHERS',
  ADMIN_TEACHER_STUDENTS = 'ADMIN_TEACHER_STUDENTS'
